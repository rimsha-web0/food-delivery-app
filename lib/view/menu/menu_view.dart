...
// RoundTextfield ki import ab zaroorat nahi hai
...
class _MenuViewState extends State<MenuView> {
  // Search controller hata diya gaya hai
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // --- Search Bar Section Removed ---

                  const SizedBox(height: 20), // Spacing adjust kar di hai
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      Map<String, dynamic> mObj = menuArr[index];
